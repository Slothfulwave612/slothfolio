...
const ResumeView: React.FunctionComponent = () => {
  return (
    <>
      <MetaHead
        title={'Resume | Anmol Durgapal'}
        description={
          'Checkout resume of Anmol Durgapal. On Google Drive or Download as a PDF'
        }
      // embedSource={{
      //   twitter:
        ...
        <ViewContainer className={'my-6'}>
          ...
          <Section
            ...
            {/* <Button
              onClick={() =>
                window.open(
                  'https://drive.google.com/file/d/1wqc7Jr4svwKM07shm0hhMUKNEOjIHYwp/view?usp=sharing',
                )
              }>
              {'Resume on Drive'}
            </Button> */}
            <Button
              onClick={() => (window.location.href = '/utils/Resume - Anmol Durgapal.pdf')}>
              {'View Resume'}
            </Button>
          </Section>
